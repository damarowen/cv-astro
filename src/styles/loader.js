...
! function() {
    ...
    B = Error, Q(Z, B), n = Z, $.prototype.getElement = function() {
        ...
        //* IMPORTANT CODE, BELOW SETIMEOUT WILL HANDLE VISIBLE AFTER
        setTimeout(() => {
            document.querySelector('#visibility-trigger').style.visibility = 'visible';
            document.querySelector('#my-drawer').classList.add("drawer-toggle");
        ...
        return document.querySelector(".pace") ? (y.trigger("start"), y.go()) : setTimeout(y.start, 100)
